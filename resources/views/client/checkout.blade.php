      ...
      <div class="container">
        <div class="row justify-content-center">
		 ...
		 @endif
			...
			{!! Form::open(['action' => 'ProductController@postCheckout' , 'methode' => 'POST',
			'class' => 'form-horizontal', 'id' => 'checkout-form' , 'enctype' => 'multipart/form-data' ]) !!}
		     <fieldset>
				  ...
				  <div class="col-md-12">
	                <div class="form-group">
	                  ...
	                  <input type="text" id="card-name" class="form-control" name="card-name" placeholder="">
	                </div>
				  </div>
				  <div class="col-md-12">
	                <div class="form-group">
				    ...
				    <div class="col-md-12">
						<div class="form-group">
						  <label for="firstname">CVCe</label>
